...
In this repo, `scripts/kagenti-setup-works-for-sally.sh` now installs a small reference
...
- [controller.yaml.envsubst](/Users/somalley/git/ambient-code/openclaw-infra/manifests/kagenti-namespace-controller/controller.yaml.envsubst)
- [KAGENTI-SETUP.md](/Users/somalley/git/ambient-code/openclaw-infra/docs/KAGENTI-SETUP.md)
- [KAGENTI-CLUSTER-ONBOARDING.md](/Users/somalley/git/ambient-code/openclaw-infra/docs/KAGENTI-CLUSTER-ONBOARDING.md)
...
- [manifests/kagenti-namespace-enrollment/kagenti-namespace-enrollment.yaml.envsubst](/Users/somalley/git/ambient-code/openclaw-infra/manifests/kagenti-namespace-enrollment/kagenti-namespace-enrollment.yaml.envsubst)
...
4. Tenant deploys OpenClaw with A2A enabled.
